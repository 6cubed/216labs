...
Funded teams with labelled audio (hydrophone, drone, bird/mink): [CARFAC pilots](../docs/carfac-pilots/) · [paid-pilot issue](https://github.com/6cubed/216labs/issues/new?template=paid-pilot.yml) (no landing form required).
