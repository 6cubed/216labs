  ...
  return (
    ...
    >
      {scheme.imageUrl ? (
        ...
        <div className="flex aspect-square w-full items-center justify-center bg-gradient-to-br from-brand-50 to-brand-100/50">
          <div className="text-center p-5">
            <Sofa className="mx-auto h-10 w-10 text-brand-300 mb-3" />
      ...
      <div className="p-5">
        ...
        {onVote && (
          <div className="mt-3 flex items-center gap-2">
            ...
            >
              ...
              {vote === "down" ? "Not my vibe" : "Not my vibe"}
            </button>
          </div>
        )}
        ...
        >
          <span className="flex items-center gap-2">
            ...
            {scheme.items.length} pieces — Shop now
          </span>
          {expanded ? (
        ...
        <div className="mt-4 rounded-xl bg-brand-50/40 p-3">
          <p className="text-xs font-medium text-brand-700/80 leading-relaxed">
            <span className="font-semibold">Designer note:</span> {scheme.designNotes}
          </p>
        </div>
      </div>
    </motion.div>
