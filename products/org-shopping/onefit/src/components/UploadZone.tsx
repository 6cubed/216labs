      ...
      <AnimatePresence mode="wait">
        {currentImage ? (
          <motion.div
            ...
            className="relative mx-auto max-w-xs overflow-hidden rounded-2xl border border-surface-200 shadow-lg"
          >
            <img
              src={currentImage}
              alt="Your photo"
            ...
            <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/40 to-transparent px-4 pb-3 pt-8">
              <p className="text-sm font-medium text-white/90">Photo uploaded</p>
            </div>
          </motion.div>
        ) : (
          <motion.div
