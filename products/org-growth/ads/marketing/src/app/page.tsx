    ...
    <div className="max-w-5xl mx-auto px-6 py-12">
      <header className="mb-10">
        ...
        <p className="mt-3 text-[var(--muted)] text-sm max-w-2xl leading-relaxed">
          ...
          <code className="text-xs text-zinc-500">products/org-growth/ads/marketing/src/data/campaign-registry.ts</code>.
        </p>
      </header>
      ...
      <footer className="border-t border-[var(--border)] pt-8 text-xs text-zinc-600">
        <p>
          To add a new per-app blog: create <code className="text-zinc-500">products/.../&lt;id&gt;blog</code> (or similar),
