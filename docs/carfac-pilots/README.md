...
216Labs sells **labelled-audio detection pilots**, not another wrapper model. The public demos are the three CARFAC Colabs in this repo — start with the [underwater SAI results](https://github.com/6cubed/216labs/tree/main/colabs/carfac-sai-underwater) (GitHub directory page; `blob/.../README.md` 404s for anonymous visitors).
