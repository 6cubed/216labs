...
Same offer as the underwater notebook: labelled-audio detection on **your** files. [CARFAC pilots](../../docs/carfac-pilots/) · [paid-pilot issue](https://github.com/6cubed/216labs/issues/new?template=paid-pilot.yml) · [hire](https://6cubed.app/#work).
