...
function ensureCronRunnerMigrations(db) {
  ...
  db.exec(`
    ...
    ('revenue-env-check', 'Revenue & edge smoke', 'HTTP probes for admin + paid apps; Telegram on failure or StoryMagic waitlist-without-payment nudge (12h). State key revenue_env_last.', '0 */4 * * *', 1),
