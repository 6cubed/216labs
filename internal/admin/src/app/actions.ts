...
const PREFIX_TO_DIR_FALLBACK: Array<[string, string]> = [
  ["NEXT_PUBLIC_STORYBOOK_", "products/org-lifestyle/play/storybook"],
  ["STORYBOOK_", "products/org-lifestyle/play/storybook"],
  ["NEXT_PUBLIC_VALENTINE_", "products/org-shopping/valentine"],
  ["VALENTINE_", "products/org-shopping/valentine"],
  ["AUDIOAICHECKUP_", "products/org-platform/ai/audioaicheckup"],
  ["NEXT_PUBLIC_ONEFIT_", "products/org-shopping/onefit"],
  ["ONEFIT_", "products/org-shopping/onefit"],
  ["NEXT_PUBLIC_ONEROOM_", "products/org-social/oneroom"],
  ["ONEROOM_", "products/org-social/oneroom"],
  ["AGIMEMES_", "products/org-lifestyle/play/agimemes.com"],
  ["PRIORS_", "products/org-platform/ai/priors"],
  ["AGITSHIRTS_", "products/org-shopping/agitshirts"],
  ["RAMBLINGRADIO_", "products/org-media/RamblingRadio"],
  ["HIVEFIND_", "products/org-platform/ai/hivefind"],
  ["CALIBRATEDAI_", "products/org-platform/ai/calibratedai"],
  ["BIGLEROYS_", "products/org-shopping/bigleroys"],
  ["ONEPAGE_", "products/org-platform/ai/1pageresearch"],
  ["ZDGAME_", "products/org-social/thezurichdatinggame"],
];
