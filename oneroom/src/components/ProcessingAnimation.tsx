...
import { Sparkles, Palette, Sofa, Camera } from "lucide-react";

const steps = [
  { icon: Sparkles, label: "Analyzing your room…" },
  { icon: Palette, label: "Curating color palettes & materials…" },
  { icon: Sofa, label: "Selecting furniture & decor…" },
  { icon: Camera, label: "Staging your room visuals…" },
];
...
export default function ProcessingAnimation({ step }: { step: number }) {
  return (
    <div className="flex flex-col items-center py-16">
      ...
      >
        Your personal designer is at work…
      </motion.p>
    </div>
  );
}
